package com.aliumujib.android.currencydatalib.cache.impl
...
class CurrencyStoreImpl @Inject constructor(
    ...
    override suspend fun save(wallets: List<Currency>) {
        currenciesDao.saveCurrencies(wallets.map(currencyMappers::mapToEntity))
    }
